...
const LandingPage: React.FC<LandingPageProps> = ({ refId, bonus, onLogin, onRegister }) => {
  ...
  return (
    <div className="h-[100dvh] bg-background text-white flex flex-col relative">
      {/* Nav */}
      <header className="relative z-20 flex items-center justify-between px-4 py-3 w-full bg-background sticky top-0 border-b border-white/[0.05]">
      ...
      <main className="relative z-10 flex-1 w-full mx-auto px-4 pb-28 pt-8 overflow-y-auto">
        ...
        <section className="mb-8">
          ...
          <div className="bg-card rounded-xl border border-white/[0.04] overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-xl border-t border-white/[0.05] p-4 z-30 pb-safe">
        ...
        <div className="flex gap-3 max-w-md mx-auto">
          ...
          <div className="flex rounded-xl bg-surface overflow-hidden flex-none border border-white/[0.06]">
            <button type="button" onClick={onRegister} className="px-4 flex items-center justify-center hover:bg-white/5 border-r border-white/[0.06] transition-colors">
            ...
            <button type="button" onClick={onRegister} className="px-4 flex items-center justify-center hover:bg-white/5 transition-colors">
