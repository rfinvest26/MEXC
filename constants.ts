...
export const STOCK_MARKET_ASSETS: Asset[] = [
  { id: 'st1', ticker: 'NVDA', name: 'NVIDIA Corporation', price: 111.11, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/nvidia--600.png', tagline: 'Лидер AI и чипов, самая активная акция' },
  { id: 'st2', ticker: 'TSLA', name: 'Tesla, Inc.', price: 277.78, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/tesla--600.png', tagline: 'Высокий объём торгов, волатильность' },
  { id: 'st3', ticker: 'AAPL', name: 'Apple Inc.', price: 200, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/apple--600.png', tagline: 'Классика, огромная капитализация' },
  { id: 'st4', ticker: 'MSFT', name: 'Microsoft Corporation', price: 433.33, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/microsoft--600.png', tagline: 'Лидер облаков и AI' },
  { id: 'st5', ticker: 'AMZN', name: 'Amazon.com, Inc.', price: 188.89, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/amazon--600.png', tagline: 'E-commerce + облако' },
  { id: 'st6', ticker: 'GOOGL', name: 'Alphabet Inc.', price: 166.67, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/alphabet--600.png', tagline: 'Google, YouTube, AI' },
  { id: 'st7', ticker: 'META', name: 'Meta Platforms', price: 555.56, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/meta-platforms--600.png', tagline: 'Соцсети + реклама + метавселенная' },
  { id: 'st8', ticker: 'AVGO', name: 'Broadcom Inc.', price: 188.89, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/broadcom--600.png', tagline: 'Полупроводники, AI' },
  { id: 'st9', ticker: 'PLTR', name: 'Palantir Technologies', price: 100, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/palantir--600.png', tagline: 'Очень популярна в 2025–2026 среди розницы' },
  { id: 'st10', ticker: 'AMD', name: 'Advanced Micro Devices', price: 100, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/advanced-micro-devices--600.png', tagline: 'Конкурент NVIDIA' },
  { id: 'st11', ticker: 'INTC', name: 'Intel Corporation', price: 22.22, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/intel--600.png', tagline: 'Высокий объём торгов в 2026' },
  { id: 'st12', ticker: 'SMCI', name: 'Super Micro Computer', price: 35.56, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/super-micro-computer--600.png', tagline: 'Серверы для AI' },
  { id: 'st13', ticker: 'ARM', name: 'Arm Holdings', price: 122.22, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/arm--600.png', tagline: 'Дизайн чипов' },
  { id: 'st14', ticker: 'COIN', name: 'Coinbase Global', price: 200, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/coinbase--600.png', tagline: 'Крипто-биржа, коррелирует с биткоином' },
  { id: 'st15', ticker: 'HOOD', name: 'Robinhood Markets', price: 44.44, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/robinhood--600.png', tagline: 'Популярна среди розничных трейдеров' },
  { id: 'st16', ticker: 'SOFI', name: 'SoFi Technologies', price: 12.22, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/sofi--600.png', tagline: 'Финтех, высокая активность' },
  { id: 'st17', ticker: 'NFLX', name: 'Netflix, Inc.', price: 1000, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/netflix--600.png', tagline: 'Стриминг' },
  { id: 'st18', ticker: 'MU', name: 'Micron Technology', price: 100, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, logoUrl: 'https://s3-symbol-logo.tradingview.com/micron-technology--600.png', tagline: 'Память для AI' },
  { id: 'st19', ticker: 'ORCL', name: 'Oracle Corporation', price: 155.56, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, tradingViewSymbol: 'NYSE:ORCL', logoUrl: 'https://etoro-cdn.etorostatic.com/market-avatars/orcl/150x150.png', tagline: 'Облачные технологии и базы данных' },
  { id: 'st20', ticker: 'BRK.B', name: 'Berkshire Hathaway Inc.', price: 477.78, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, tradingViewSymbol: 'NYSE:BRK.B', logoUrl: 'https://porti.ru/resource/img/company/logo/29302.png', tagline: 'Холдинг Уоррена Баффета' },
  { id: 'st21', ticker: 'JPM', name: 'JPMorgan Chase & Co.', price: 244.44, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, tradingViewSymbol: 'NYSE:JPM', logoUrl: 'https://s3-symbol-logo.tradingview.com/jpmorgan-chase--600.png', tagline: 'Крупнейший банк США' },
  { id: 'st22', ticker: 'XOM', name: 'Exxon Mobil Corporation', price: 105.56, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, tradingViewSymbol: 'NYSE:XOM', logoUrl: 'https://s3-symbol-logo.tradingview.com/exxon--600.png', tagline: 'Нефть и газ' },
  { id: 'st23', ticker: 'TSM', name: 'Taiwan Semiconductor', price: 166.67, volume24h: 0, change24h: 0, category: 'stock', priceUnavailable: false, tradingViewSymbol: 'NYSE:TSM', logoUrl: 'https://s3-symbol-logo.tradingview.com/taiwan-semiconductor--600.png', tagline: 'Контрактное производство чипов' },
];
